...
export class CalendarComponent {
        ...
        this.calendarOptions = {
            ...
            select: (start, end, allDay): void => {
                this.createEvent = () => {
                    ...
                    (<any>jQuery('#create-event-modal')).modal('hide');
                };

                (<any>jQuery('#create-event-modal')).modal('show');
            },
            eventClick: (event): void => {
                this.event = event;
                (<any>jQuery('#show-event-modal')).modal('show');
            },
            editable: true,
            droppable: true,
            ...
            drop: (dateItem, event): void => { // this function is called when something is dropped
                ...
                let copiedEventObject = <any>jQuery.extend({}, originalEventObject);
    ...
    ngOnInit(): void {
        ...
        (<any>jQuery('.draggable')).draggable(this.dragOptions);
