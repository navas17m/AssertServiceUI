...
@Component({
    selector: 'carerofstednotificationdata',
    templateUrl: './carerofstednotificationdata.component.template.html',
})

export class CarerOfstedNotificationDataComponent implements OnInit {
    ...
    constructor(private apiService: APICallService, private _formBuilder: FormBuilder,
        ...
        this.objOfstedNotification.AgencyProfileId = this.AgencyProfileId;
        this.CarerParentId = parseInt(Common.GetSession("ACarerParentId"));
        this.SocialWorkerId = Common.GetSession("ACarerSSWId");
        this.objOfstedNotification.CarerParentId = this.CarerParentId;
        this.SequenceNo = this.objQeryVal.id;
       // this.fnLoadDDL();
        this.objOfstedNotification.SequenceNo = this.SequenceNo;
        ...
        if (this.SequenceNo != 0 && this.SequenceNo != null) {
            ...
            this.objOfstedNotification.SequenceNo = 0;
            apiService.post(this.controllerName, "GetDynamicControls", this.objOfstedNotification).then(data => { this.dynamicformcontrol = data; });
        }
        ...
        if (Common.GetSession("SaveAsDraft") == "N") {
            ...
            this.objOfstedNotification.SequenceNo = this.SequenceNo;
            this.objOfstedNotification.AgencyProfileId = this.AgencyProfileId;
            apiService.post(this.controllerName, "GetDynamicControls", this.objOfstedNotification).then(data => {
    ...
    clicksubmit(mainFormBuilder, dynamicForm, dynamicformbuilder, UploadDocIds, IsUpload, uploadFormBuilder, AddtionalEmailIds, EmailIds) {
        ...
        if (dynamicformbuilder.valid && dynamicForm != '' && this.DocOk) {
            ...
            if (this.isDirty || (IsUpload && uploadFormBuilder.valid)) {
                ...
                this.objOfstedNotification.AgencyProfileId = this.AgencyProfileId;
                this.objOfstedNotification.DynamicValue = dynamicForm;
                this.objOfstedNotification.NotificationEmailIds = EmailIds;
                this.objOfstedNotification.NotificationAddtionalEmailIds = AddtionalEmailIds;
                this.apiService.save(this.controllerName, this.objOfstedNotification, type).then(data => this.Respone(data, type, IsUpload, this.skipAlert));
            }
            else {
    ...
    ngOnInit() {
        ...
        this.st.newTimer('OfstedNotification180', environment.autoSaveTime);
    ...
    subscribeTimer2() {
        if (this.timer2Id) {
            ...
            this.timer2Id = this.st.subscribe('OfstedNotification180', () => this.timer2callback());
        ...
        if (this.isReadOnly == "0" || this.isReadOnly == null) {
            if (this.isFirstTime) {
                ...
                if (this.SequenceNo > 0 && Common.GetSession("SaveAsDraft") == "N") {
                    ...
                    this.objOfstedNotification.IsSubmitted = false;
    ...
    ngOnDestroy() {
        this.st.delTimer('OfstedNotification180');
    }

    fnDonloadPDF() {
        window.location.href = this.apiURL + "GenerateCarerOfstedNotificationPDF/" + this.CarerCode + "," + this.CarerParentId + "," + this.SequenceNo + "," + this.AgencyProfileId;
    ...
    fnDonloadWord() {
        window.location.href = this.apiURL + "GenerateCarerOfstedNotificationWord/" + this.CarerCode + "," + this.CarerParentId + "," + this.SequenceNo + "," + this.AgencyProfileId;
    ...
    fnPrint() {
        this.apiService.get("GeneratePDF", "GenerateCarerOfstedNotificationPrint", this.CarerCode + "," + this.CarerParentId + "," + this.SequenceNo + "," + this.AgencyProfileId).then(data => {
            var popupWin;
            var style = ""; var link = "";
            var i;
    ...
    fnEmail(form) {
        ...
        if (form.valid) {
            ...
            this.apiService.post("GeneratePDF", "EmailCarerOfstedNotification", this.objNotificationDTO).then(data => {
                if (data == true){
