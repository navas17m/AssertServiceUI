...
@Component
    ({
    selector: 'RiskAssessmentListParamount',
    templateUrl: './riskassessmentlistparamount.component.template.html',
    })

export class RiskAssessmentListParamountComponent {
    ...
    constructor(private apiService: APICallService, private modal: PagesComponent,
        ...
        if (Common.GetSession("ChildId") != null && Common.GetSession("ChildId") != 'null') {
            ...
            Common.SetSession("UrlReferral", "pages/child/riskassessmentlistparamount/4");
    ...
    fnLoadSaveDraft() {
        ...
        this.objSaveDraftInfoDTO.FormCnfgId = 405;
    ...
    fnAddData() {
        this._router.navigate(['/pages/child/riskassessmentdataparamount/0/0/4/1']);
    }
    ...
    editSaferCarePolicy(id, CId,hasDraft) {
        ...
        this._router.navigate(['/pages/child/riskassessmentdataparamount/' + id + "/0/" + "4"+"/"+this.insActivePage]);
    }
    ...
    onSignClick($event){
        this._router.navigate(['/pages/child/riskassessmentdataparamountfcsignature',$event.SequenceNo,$event.CarerParentId]);
    }
