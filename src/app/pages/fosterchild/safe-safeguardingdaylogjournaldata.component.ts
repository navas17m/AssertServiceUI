...
@Component({
        selector: 'safe-safeguardingdaylogjournaldata',
        templateUrl: './safe-safeguardingdaylogjournaldata.component.template.html',
})

export class ChildSafeguardingDayLogJournalDataComponent {
    ...
    private Respone(data, type, IsUpload) {
        ...
        if (data.IsError == true) {
            ...
            this.objUserAuditDetailDTO.ChildCarerEmpId = this.ChildID;
            Common.addUserAuditHistoryDetails(this.objUserAuditDetailDTO);
            this._router.navigate(['/pages/child/safeguardingdaylogjournallist/42']);
        }
    }
}
