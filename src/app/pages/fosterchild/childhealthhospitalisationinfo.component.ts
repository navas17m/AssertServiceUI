...
//.@Pipe({ name: 'groupBy' })
@Component({
        selector: 'childhealthhospitalisationinfo',
        templateUrl: './childhealthhospitalisationinfo.component.template.html',
        providers: [ChildHealthHospitalisationInfoService]
})

export class ChildHealthHospitalisationInfoComponent {
    ...
    FormCnfgId=114;
    constructor(private location: Location, private _formBuilder: FormBuilder, private ChildHHService: ChildHealthHospitalisationInfoService,
    ...
    private Respone(data, type, IsUpload) {    
        ...
        if (data.IsError == true) {
            ...
            this.objUserAuditDetailDTO.ChildCarerEmpId = this.ChildID;
            Common.addUserAuditHistoryDetails(this.objUserAuditDetailDTO);
            this._router.navigate(['/pages/child/childhealthhospitalisationinfolist/19']);
        }
    }
}