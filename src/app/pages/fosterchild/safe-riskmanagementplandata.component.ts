...
@Component({
        selector: 'safe-riskmanagementplandata',
        templateUrl: './safe-riskmanagementplandata.component.template.html',
})

export class ChildRiskManagementPlansDataComponent {
    ...
    private Respone(data, type, IsUpload) {
        ...
        if (data.IsError == true) {
            ...
            this.objUserAuditDetailDTO.ChildCarerEmpId = this.ChildID;
            Common.addUserAuditHistoryDetails(this.objUserAuditDetailDTO);
            this._router.navigate(['/pages/child/riskmanagementplanlist/19']);
        }
    }
}
