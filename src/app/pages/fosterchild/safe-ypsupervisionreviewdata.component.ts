...
@Component({
        selector: 'safe-ypsupervisionreviewdata',
        templateUrl: './safe-ypsupervisionreviewdata.component.template.html',
})

export class ChildYPSupervisionReviewDataComponent {
    ...
    private Respone(data, type, IsUpload) {
        ...
        if (data.IsError == true) {
            ...
            this.objUserAuditDetailDTO.ChildCarerEmpId = this.ChildID;
            Common.addUserAuditHistoryDetails(this.objUserAuditDetailDTO);
            this._router.navigate(['/pages/child/ypsupervisionreviewlist/42']);
        }
    }
}
