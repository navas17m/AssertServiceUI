...
@Component({
        selector: 'safe-therapyupdatereportsdata',
        templateUrl: './safe-therapyupdatereportsdata.component.template.html',
})

export class ChildTherapyUpdateReportsDataComponent {
    ...
    private Respone(data, type, IsUpload) {
        ...
        if (data.IsError == true) {
            ...
            this.objUserAuditDetailDTO.ChildCarerEmpId = this.ChildID;
            Common.addUserAuditHistoryDetails(this.objUserAuditDetailDTO);
            this._router.navigate(['/pages/child/therapyupdatereportslist/42']);
        }
    }
}
