...
@Component({
        selector: 'safe-riskandneedsassessmentsdata',
        templateUrl: './safe-riskandneedsassessmentsdata.component.template.html',
})

export class ChildRiskNeedsAssessmentsDataComponent {
    ...
    private Respone(data, type, IsUpload) {
        ...
        if (data.IsError == true) {
            ...
            this.objUserAuditDetailDTO.ChildCarerEmpId = this.ChildID;
            Common.addUserAuditHistoryDetails(this.objUserAuditDetailDTO);
            this._router.navigate(['/pages/child/riskandneedsassessmentslist/42']);
        }
    }
}
