...
@Component({
        selector: 'safe-youngpeoplesactivitiesdata',
        templateUrl: './safe-youngpeoplesactivitiesdata.component.template.html',
})

export class ChildYoungPeoplesActivitiesDataComponent {
    ...
    private Respone(data, type, IsUpload) {
        ...
        if (data.IsError == true) {
            ...
            this.objUserAuditDetailDTO.ChildCarerEmpId = this.ChildID;
            Common.addUserAuditHistoryDetails(this.objUserAuditDetailDTO);
            this._router.navigate(['/pages/child/youngpeoplesactivitieslist/42']);
        }
    }
}
