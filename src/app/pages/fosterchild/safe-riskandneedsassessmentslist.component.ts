...
@Component
    ({
    selector: 'safe-riskandneedsassessmentslist',
    templateUrl: './safe-riskandneedsassessmentslist.component.template.html',
    })

export class ChildRiskNeedsAssessmentsListComponent {
    controllerName = "ChildRiskNeedsAssessments";
    gridList = [];
    ChildID: number;
    ...
    constructor(private apiService: APICallService, private _router: Router, private modal: PagesComponent)
    {
        if (Common.GetSession("ChildId") != null && Common.GetSession("ChildId") != 'null') {
            ...
            Common.SetSession("UrlReferral", "pages/child/riskandneedsassessmentslist/42");
    ...
    fnAddData() {
        this._router.navigate(['/pages/child/riskandneedsassessmentsdata/0/42']);
    }

    edit(id) {
        this._router.navigate(['/pages/child/riskandneedsassessmentsdata', id,42]);
    }
