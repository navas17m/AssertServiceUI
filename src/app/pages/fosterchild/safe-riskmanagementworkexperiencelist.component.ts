...
@Component
    ({
    selector: 'safe-riskmanagementworkexperiencelist',
    templateUrl: './safe-riskmanagementworkexperiencelist.component.template.html',
    })

export class ChildRiskManagementWorkExperienceListComponent {
    controllerName = "ChildRiskManagementWorkExperience";
    gridList = [];
    ChildID: number;
    ...
    constructor(private apiService: APICallService, private _router: Router, private modal: PagesComponent)    {
        if (Common.GetSession("ChildId") != null && Common.GetSession("ChildId") != 'null') {
            ...
            Common.SetSession("UrlReferral", "pages/child/riskmanagementwelist/42");
    ...
    fnAddData() {
        this._router.navigate(['/pages/child/riskmanagementwedata/0/19']);
    }

    edit(id) {
        this._router.navigate(['/pages/child/riskmanagementwedata', id,19]);
    }
