...
@Component
    ({
    selector: 'safe-youngpeoplesactivitieslist',
    templateUrl: './safe-youngpeoplesactivitieslist.component.template.html',
    })

export class ChildYoungPeoplesActivitiesListComponent {
    controllerName = "ChildYoungPeoplesActivities";
    gridList = [];
    ChildID: number;
    ...
    constructor(private apiService: APICallService, private _router: Router, private modal: PagesComponent)
    {
        if (Common.GetSession("ChildId") != null && Common.GetSession("ChildId") != 'null') {
            ...
            Common.SetSession("UrlReferral", "pages/child/youngpeoplesactivitieslist/42");
    ...
    fnAddData() {
        this._router.navigate(['/pages/child/youngpeoplesactivitiesdata/0/42']);
    }

    edit(id) {
        this._router.navigate(['/pages/child/youngpeoplesactivitiesdata', id,42]);
    }
