...
@Component({
        selector: 'safe-disruptionmeetingminutesdata',
        templateUrl: './safe-disruptionmeetingminutesdata.component.template.html',
})

export class SafeDisruptionMeetingMinutesDataComponent {
    ...
    private Respone(data, type, IsUpload) {
        ...
        if (data.IsError == true) {
            ...
            this.objUserAuditDetailDTO.ChildCarerEmpId = this.ChildID;
            Common.addUserAuditHistoryDetails(this.objUserAuditDetailDTO);
            this._router.navigate(['/pages/child/disruptionmeetingminuteslist/19']);
        }
    }
}
