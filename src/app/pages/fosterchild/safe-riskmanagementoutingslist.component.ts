...
@Component
    ({
    selector: 'safe-riskmanagementoutingslist',
    templateUrl: './safe-riskmanagementoutingslist.component.template.html',
    })

export class RiskManagementOutingsListComponent {
    ...
    constructor(private apiService: APICallService, private _router: Router, private modal: PagesComponent)
    {
        if (Common.GetSession("ChildId") != null && Common.GetSession("ChildId") != 'null') {
            ...
            Common.SetSession("UrlReferral", "pages/child/riskmanagementoutingslist/19");
            this._router.navigate(['/pages/referral/childprofilelist/1/42']);
        }
    ...
    fnAddData() {
        this._router.navigate(['/pages/child/riskmanagementoutingsdata/0/42']);
    }

    edit(id) {
        this._router.navigate(['/pages/child/riskmanagementoutingsdata', id,19]);
    }
