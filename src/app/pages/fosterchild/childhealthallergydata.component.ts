...
@Component({
        selector: 'childhealthallergydata',
        templateUrl: './childhealthallergydata.component.template.html',
        providers: [ChildHealthHospitalisationInfoService]
})

export class ChildHealthAllergydataComponent {
    ...
    private Respone(data, type, IsUpload) {
        ...
        if (data.IsError == true) {
            ...
            this.objUserAuditDetailDTO.ChildCarerEmpId = this.ChildID;
            Common.addUserAuditHistoryDetails(this.objUserAuditDetailDTO);
            this._router.navigate(['/pages/child/allergylist/19']);
        }
    }
}
