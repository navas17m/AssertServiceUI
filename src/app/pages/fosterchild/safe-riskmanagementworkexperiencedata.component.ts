...
@Component({
        selector: 'safe-riskmanagementworkexperience',
        templateUrl: './safe-riskmanagementworkexperiencedata.component.template.html',
})

export class ChildRiskManagementWorkExperienceDataComponent {
    ...
    private Respone(data, type, IsUpload) {
        ...
        if (data.IsError == true) {
            ...
            this.objUserAuditDetailDTO.ChildCarerEmpId = this.ChildID;
            Common.addUserAuditHistoryDetails(this.objUserAuditDetailDTO);
            this._router.navigate(['/pages/child/riskmanagementwelist/42']);
        }
    }
}
