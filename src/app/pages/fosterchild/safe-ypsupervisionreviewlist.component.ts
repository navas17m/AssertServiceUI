...
@Component
    ({
    selector: 'safe-ypsupervisionreviewlist',
    templateUrl: './safe-ypsupervisionreviewlist.component.template.html',
    })

export class ChildYPSupervisionReviewListComponent {
    controllerName = "ChildYPSupervisionReview";
    gridList = [];
    ChildID: number;
    ...
    constructor(private apiService: APICallService, private _router: Router, private modal: PagesComponent)
    {
        if (Common.GetSession("ChildId") != null && Common.GetSession("ChildId") != 'null') {
            ...
            Common.SetSession("UrlReferral", "pages/child/ypsupervisionreviewlist/42");
    ...
    fnAddData() {
        this._router.navigate(['/pages/child/ypsupervisionreviewdata/0/42']);
    }

    edit(id) {
        this._router.navigate(['/pages/child/ypsupervisionreviewdata', id,42]);
    }
