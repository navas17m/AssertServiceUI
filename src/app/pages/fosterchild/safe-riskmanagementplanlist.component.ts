...
@Component
    ({
    selector: 'safe-riskmanagementplanlist',
    templateUrl: './safe-riskmanagementplanlist.component.template.html',
    })

export class RiskManagementplanListComponent {
    controllerName = "ChildRiskManagementPlans";
    gridList = [];
    ChildID: number;
    ...
    constructor(private apiService: APICallService, private _router: Router, private modal: PagesComponent)
    {
        if (Common.GetSession("ChildId") != null && Common.GetSession("ChildId") != 'null') {
            ...
            Common.SetSession("UrlReferral", "pages/child/riskmanagementplanlist/42");
    ...
    fnAddData() {
        this._router.navigate(['/pages/child/riskmanagementplandata/0/19']);
    }

    edit(id) {
        this._router.navigate(['/pages/child/riskmanagementplandata', id,19]);
    }
