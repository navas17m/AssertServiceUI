...
@Component
    ({
    selector: 'safe-therapyupdatereportslist',
    templateUrl: './safe-therapyupdatereportslist.component.template.html',
    })

export class ChildTherapyUpdateReportsListComponent {
    controllerName = "ChildTherapyUpdateReports";
    gridList = [];
    ChildID: number;
    ...
    constructor(private apiService: APICallService, private _router: Router, private modal: PagesComponent)
    {
        if (Common.GetSession("ChildId") != null && Common.GetSession("ChildId") != 'null') {
            ...
            Common.SetSession("UrlReferral", "pages/child/therapyupdatereportslist/42");
    ...
    fnAddData() {
        this._router.navigate(['/pages/child/therapyupdatereportsdata/0/42']);
    }

    edit(id) {
        this._router.navigate(['/pages/child/therapyupdatereportsdata', id,42]);
    }
