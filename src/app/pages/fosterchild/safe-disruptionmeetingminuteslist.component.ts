...
@Component
    ({
    selector: 'safe-disruptionmeetingminuteslist',
    templateUrl: './safe-disruptionmeetingminuteslist.component.template.html',
    })

export class SafeDisruptionMeetingMinutesListComponent {
    controllerName = "ChildDisruptionMeetingMinutes";
    gridList = [];
    ChildID: number;
    ...
    fnAddData() {
        this._router.navigate(['/pages/child/disruptionmeetingminutesdata/0/19']);
    }

    edit(id) {
        this._router.navigate(['/pages/child/disruptionmeetingminutesdata', id,19]);
    }
