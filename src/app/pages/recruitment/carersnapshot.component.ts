...
@Component({
    selector: 'CarerSnapshot',
    templateUrl: './carersnapshot.component.template.html',
...
export class CarerSnapshotComponet {
    ...
    constructor(private _router: Router,private activatedroute: ActivatedRoute,
      private apiService: APICallService, private spinner: NgxSpinnerService) {
    ...
    BindSnapshotInfo(id) {
        if (id != null && id != '') {
            ...
            this.apiService.get(this.controllerName, "GetSnapShotInfo", id).then(data => {
                ...
                // console.log(data);
                //console.log("11");
                this.CarerParentId=data.PrimaryCarer.CarerParentId;;
                this.GetCarerTrainingAndPlacementsInfo();
